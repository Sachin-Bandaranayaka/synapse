  ...
  return (
    <form action={dispatch} className="m-8 max-w-xl">
      <div className="space-y-8">
        <div>
          <h2 className="text-2xl font-bold leading-7 text-gray-900">Create a New Tenant</h2>
        ...
        <div className="border-b border-gray-900/10 pb-8">
          <h3 className="text-base font-semibold leading-7 text-gray-900">Tenant Information</h3>
          <div className="mt-4">
            <label htmlFor="tenantName" className="block text-sm font-medium leading-6 text-gray-900">Tenant Name</label>
        ...
        <div className="border-b border-gray-900/10 pb-8">
          <h3 className="text-base font-semibold leading-7 text-gray-900">Tenant Admin User</h3>
          <div className="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
            <div>
              <label htmlFor="adminName" className="block text-sm font-medium leading-6 text-gray-900">Admin Name</label>
            ...
            <div>
              <label htmlFor="adminEmail" className="block text-sm font-medium leading-6 text-gray-900">Admin Email</label>
            ...
            <div className="sm:col-span-2">
              <label htmlFor="adminPassword" className="block text-sm font-medium leading-6 text-gray-900">Admin Password</label>
